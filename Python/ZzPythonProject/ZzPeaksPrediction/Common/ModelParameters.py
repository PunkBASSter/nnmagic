class ModelParameters:
    ...
    io_file_name = f"{io_mt_data_file_prefix}_{io_mt_symbol_name}_{io_mt_timeframe}"
    io_folder = "C:\\Users\\PunkBASSter\\AppData\\Roaming\\MetaQuotes\\Terminal\\Common\\Files\\"
    io_input_data_file = io_folder + io_file_name + ".csv"
    #io_normalized_data_file = io_folder + "Normalized_" + io_file_name
    io_predictions_data_file = io_folder + "Predictions_" + io_file_name + ".csv"
    io_trained_model_file = io_folder + "Trained_Model_" + io_file_name + ".cmf"
    ...
    #Prediction settings
    pred_N = 12  # input: N subsequent values
