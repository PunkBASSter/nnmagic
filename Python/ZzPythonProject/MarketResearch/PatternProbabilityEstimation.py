...
sequence_len = 1 #Length of sequences of Indicator Values to analyse

#Filling DataFrame with basic data, Indicator Values, MA, STD
...
#Defining a zone based on bands where Indicator Value is located
...
sequence_df = sequence_df.groupby(sequence_df.columns.tolist()).size().reset_index(name='count')
